...
Éstas reglas son la base sobre la cual mantenemos la comunidad de osu! como un lugar entretenido y acogedor para todos.

##Reglas de la Comunidad

  1.  **Cada jugador puede tener sólamente UNA cuenta, en todo momento.** La *primera* cuenta que creas durante el regstro de cuenta será tu única cuenta de *osu!*, desde el momento de su creación para siempre jamás. Ésta cuenta TUYA. No es de nadie más, (no es de tu hermano, tu madre, tu hermana ni de tu amigo) es TUYA. No compartas tu cuenta con nadie más. No podrás hacer una nueva si pierdes acceso a tu cuenta. Mantenla segura.
  2.  **Juega limpio.** Usar herramientas de terceros de cualquier tipo para obtener cualquier forma de ventaja no está bien. Ésto incluye cosas como macros, programas de asistencia de puntería, modificación de escalas de tiempo, y demáses. Si algún programa te está ayudando a hacer algo que deberías hacer tú mismo en el juego, no está bien.
...
##Reglas del Chat del Juego
 ...
  4.  **Anima el juego limpio y no prestes atención a tramposos o usuarios tóxicos.** Éstas personas desafortunadamente existen y el prestarles atención sólo los incentiva a continuar o incluso provocar a otros a actuar al igual que ellos. Repórtalos a través del comando de chat `!report` o con los botones en su página de perfil y no te molestes con ellos.
  5.  **Mantén el chat limpio y apropiado para una comunidad para todas las edades, evitando tópicos de contenido inapropiado (NSFW) siempre que sea posible.** Contenido inapropiado claramente no es apropiado para una comunidad para todas las edades. Puedes hacer lo que quieras en los chats privados (con mesura claro), pero mantén los canales públicos limpios por el bien de todos.
...
##Reglas del Foro
  ...
  1.  **Publica solo contenido/tópicos significativos, interesante o de otra forma, atractivos.** Los foros son principalmente sobre discusión, así que asegúrate de esforzarte en hacer que valga la pena el tiempo de todos.
  ...
  3.  **Sé productivo con tus críticas sin tener que recurrir a ataques personales.** La crítica es algo maravillo cuando se hace de la manera correcta, pero si estás recurriendo a ataque personales para probar tu punto de vista, lo estás haciendo mal y deberías sentirte mal por ello.
  4.  **Mantén los hilos (threads) relacionados y evita resucitar tópicos viejos si la conversación ya ha muerto.** Si un tópico ha estado muerto por años, significa que ya no es relevante, así que déjalo esfumarse. Publica uno nuevo, o puedes quizás buscar y ver si alguien ya ha respondido tu pregunta.
...
##Reglas de Presentación de Beatmaps

  Estas reglas aplican estríctamente a los beatmaps que sean presentados a través del [Sistema de Presentación de Beatmaps](https://osu.ppy.sh/help/wiki/Glossary/#bss) dentro del juego. Estos hilos/discusiones son creados a través del cliente osu! cuando un beatmap es presentado a través del [editor](https://osu.ppy.sh/help/wiki/Beatmap_Editor).

  Existe un set de reglas más detallado para la construcción de beatmaps, conocido como Los [Criterios de Ranking](https://osu.ppy.sh/help/wiki/Ranking_Criteria).
...
##Reglas Off-Topic
  ...
  *Las siguientes reglas aplican SÓLO al subforo [Off-Topic](https://osu.ppy.sh/community/forums/52) a menos que se diga lo contrario.*
  ...
  1.  **Ningún tópico en Off-Topic tiene valor.** Son simplemente basura. Si tus hilos son constantemente movidos a Off-Topic, es porque son juzgados como no merecerdores de una discusión seria. Capta la insinuación.
  ...
  3.  **Los hilos de cumpleaños están permitidos solo en Off-Topic y en ningún otro lado.** Todos los hilos de cumpleaños deben ser acompañados de no menos de tres (3) imágenes de chicas animé bailando o sino serán *implacablemente* arrojados bajos un bus.

##¿Qué pasa si rompo las reglas?

  Si te encuentras en el lado equivocado de nuestras reglas de comunidad, malas cosas pasarán.
